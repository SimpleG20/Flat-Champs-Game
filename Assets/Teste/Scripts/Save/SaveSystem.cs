...
public static class SaveSystem
{
    ...
    public static void CarregarPlayer()
    {
        ...
        Debug.Log("Data Player Carregada com Sucesso");
    }
    ...
    public static void CarregarMenu()
    {
        ...
        GameManager.Instance.m_statsManager.SetarComponentes(); //stats
        ...
        Debug.Log("Data Menu Carregada com Sucesso");
    }

    public static void CarregarConfiguration()
    {
        ConfigurationData configData = LoadConfiguration();
